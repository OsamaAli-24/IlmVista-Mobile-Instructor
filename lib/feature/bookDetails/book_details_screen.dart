...
class _BookDetailsScreenState extends State<BookDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<BookDetailController>(builder: (controller) {
        return controller.isLoading
            ? const LoadingIndicator()
            : controller.bookDetail != null
                ? mainUI(controller.bookDetail!)
                : const SizedBox();
      }),
      bottomNavigationBar:
  ...
  Widget mainUI(BookDetailData data) {
    return CustomScrollView(
      slivers: [
        SliverToBoxAdapter(
            child:
                BookDetailsHeaderSection(data: detailController.bookDetail!)),
        SliverToBoxAdapter(
        ...
        if (data.rating != null)
          SliverToBoxAdapter(
            ...
            rating: detailController.bookDetail!.rating!,
            id: data.id!,
          )),
        SliverToBoxAdapter(
