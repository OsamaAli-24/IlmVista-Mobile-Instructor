...
enum NoDataType {
  cart, notification, booking, coupon, others, home, offers, address,search, course,inbox, category
}
...
class NoDataScreen extends StatelessWidget {
  ...
  const NoDataScreen({required this.text, this.type,  this.isShowHomePage = true, });
