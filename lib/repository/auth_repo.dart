...
class AuthRepo {
  ...
  Future<Response?> login(
    ...
    return await apiClient.postData(
        AppConstants.instructorLogin, {"email": email, "password": password});
  }
  ...
  //--------------------------------------change password
  Future<Response?> changeUserPassword(ChangePasswordBody passwordBody) async {
    return await apiClient.postData(
        AppConstants.changeUserPassword, passwordBody.toJson());
  }
  ...
  Future<bool?> saveUserToken(String token) async {
    ...
    // apiClient.updateHeader(token, sharedPreferences.getString(AppConstants.user) != null ?
  ...
  //----------------------------save profile image
  Future<bool?> saveProfileImage(String profileImage) async {
    return await sharedPreferences.setString(
        AppConstants.instructorProfileImage, profileImage);
  }

  //-----------------------------get user profile
  String get getInstructorProfileImage =>
      sharedPreferences.getString(AppConstants.instructorProfileImage) ?? "";
