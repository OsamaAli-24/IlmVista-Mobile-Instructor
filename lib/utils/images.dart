class Images {
  ...
  static const String  placeholderSquare = 'assets/images/placeholder_square.png';
  ...
  static String get demoBook => 'demo_book'.png;
  ...
  static String get demoCourseImage => 'demo_course_image'.png;
  static String get demoCouponBanner => 'demo_coupon_banner'.png;
  static String get demoTending => 'demo_tending'.png;
  static String get demoBookBanner => 'demo_book_banner'.png;
  ...
  static String get profile => 'profile_small'.svg;
  ...
  static String get introFirst => 'intro_first'.svg;
  static String get introSecond => 'intro_second'.svg;
  static String get introThird => 'intro_third'.svg;
  ...
  static String get earning => 'earning'.svg;
  static String get course => 'course'.svg;
  static String get student => 'student'.svg;
  static String get enrollment => 'enrollment'.svg;
  static String get menu => 'menu'.svg;
  static String get appbarMenu => 'appbar_menu'.svg;
  static String get totalEnrolment => 'total_enrolment'.svg;
  static String get totalRevenue => 'total_revenue'.svg;
  static String get totalStudent => 'total_student'.svg;

  static String get development => 'development'.png;
  static String get colorPicker => 'color_picker'.svg;
  static String get filter => 'filter'.svg;
  static String get moreVert => 'more_vert'.svg;
  static String get revenue => 'revenue'.svg;
  static String get country => 'country'.svg;
  static String get location => 'location'.svg;
  static String get organizationDemoLogo => 'organization_demo_logo'.svg;
  static String get payment => 'payment'.svg;
  static String get flagOfBangladesh => 'flag_of_bangladesh'.png;
}
